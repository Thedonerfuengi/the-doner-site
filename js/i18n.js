...
const UI_STRINGS = {
  fr: {
    ...
    hero_tagline: "THE DONER Fuengirola — Kebab halal & grillades turcs cuits à la pierre de lave, pain maison",
    ...
    story_text: "Chez THE DONER, la viande halal tourne lentement sur broche et cuit à la pierre de lave pour un goût fumé authentique. Pain maison pétri chaque jour, bulgur turc, sauces maison : tout est pensé pour un kebab généreux et sans compromis, servi en plein cœur de Fuengirola, sur la Costa del Sol, à proximité de Málaga et Marbella.",
    ...
    badge4_title: "Viande halal", badge4_sub: "certifiée & tracée",
  ...
  en: {
    ...
    hero_tagline: "THE DONER Fuengirola — Halal Turkish kebab & grill dishes cooked on lava stone, homemade bread",
    ...
    story_text: "At THE DONER, the halal meat turns slowly on the spit and cooks on lava stone for an authentic smoky flavour. Homemade bread kneaded every day, Turkish bulgur, homemade sauces: everything is designed for a generous, no-compromise kebab, served in the heart of Fuengirola, on the Costa del Sol, close to Málaga and Marbella.",
    ...
    badge4_title: "Halal meat", badge4_sub: "certified & traceable",
  ...
  es: {
    ...
    hero_tagline: "THE DONER Fuengirola — Kebab halal y parrilladas turcas cocinadas a la piedra volcánica, pan casero",
    ...
    story_text: "En THE DONER, la carne halal gira lentamente en el asador y se cocina a la piedra volcánica para un sabor ahumado auténtico. Pan casero amasado cada día, bulgur turco, salsas caseras: todo está pensado para un kebab generoso y sin concesiones, servido en pleno corazón de Fuengirola, en la Costa del Sol, cerca de Málaga y Marbella.",
    ...
    badge4_title: "Carne halal", badge4_sub: "certificada y trazable",
